...
## Diff stat
 ...
 apps/demo-office/src/App.test.tsx                  | 338 ++++++++++++++++++++-
 ...
 docs/superpowers/plans/task-1-report.md            |  95 ++++++
 packages/control-ui/src/ControlPanel.test.tsx      |  53 ++++
 packages/control-ui/src/ControlPanel.tsx           |  71 ++++-
 packages/control-ui/src/components/Card.tsx        |  40 ++-
 packages/control-ui/src/control-panel.css          |  14 +
 .../src/__tests__/office-scene.test.ts             | 107 +++++++
 packages/pixel-office/src/index.ts                 |   1 +
 packages/pixel-office/src/office-scene.ts          |  18 ++
 .../pixel-office/src/renderer/agent-renderer.ts    |  52 ++++
 .../pixel-office/src/renderer/room-renderer.ts     |  20 ++
 packages/pixel-office/src/selection.ts             |   6 +
 18 files changed, 1443 insertions(+), 31 deletions(-)

## Full diff

diff --git a/apps/demo-office/src/App.test.tsx b/apps/demo-office/src/App.test.tsx
index dd4c055..292e431 100644
--- a/apps/demo-office/src/App.test.tsx
+++ b/apps/demo-office/src/App.test.tsx
@@ -27,26 +27,38 @@ vi.mock("@agent-office/control-ui/life-sim", async () => {
     ...actual,
...
+  }),
 ...
 class ResizeObserverMock {
   ...
   observe() {}
   disconnect() {}
@@ -482,10 +494,324 @@ describe("DemoControls panel card", () => {
...
+
 export const App: FC<AppProps> = ({
   ...
   onRetry,
   lifeSimSession,
@@ -90,33 +141,48 @@ export const App: FC<AppProps> = ({
     session,
     store,
     gateway,
     runtimeId,
...
@@ -155,20 +221,28 @@ export const App: FC<AppProps> = ({
...
@@ -182,20 +256,74 @@ export const App: FC<AppProps> = ({
     }
   };
...
+  onSelect,
   ...
   const runAction = async (key: string, fn: () => Promise<void>): Promise<void> => {
     setActionErrors((prev) => {
       const next = { ...prev };
@@ -132,20 +137,39 @@ export const ControlPanel: FC<ControlPanelProps> = ({
           ...
           {visibleErrors.map((err, index) => {
             ...
             return (
               <ErrorBanner
                 ...
                 code={code}
@@ -171,86 +195,109 @@ export const ControlPanel: FC<ControlPanelProps> = ({
...
@@ -268,39 +315,49 @@ export const ControlPanel: FC<ControlPanelProps> = ({
...
@@ -222,20 +223,37 @@ export class PixelOfficeScene {
       try {
...
@@ -58,38 +59,64 @@ interface AgentPosture {
 }
...
@@ -199,20 +226,45 @@ export class AgentRenderer {
...
@@ -53,20 +68,25 @@ export class RoomRenderer {
