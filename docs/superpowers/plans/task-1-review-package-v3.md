...
## Diff stat
 ...
 packages/control-ui/src/ControlPanel.test.tsx      |  77 ++++-
 packages/control-ui/src/ControlPanel.tsx           | 103 +++++-
 ...
 21 files changed, 1773 insertions(+), 38 deletions(-)
...
+import { describe, it, expect, vi, beforeEach, afterEach } from "vitest";
 ...
 const capabilities: AdapterCapabilities = {
   ...
   features: {
     snapshot: true,
     sse: false,
@@ -549,10 +549,85 @@ describe("ControlPanel", () => {
...
+  onSelect,
   ...
   const runAction = async (key: string, fn: () => Promise<void>): Promise<void> => {
     setActionErrors((prev) => {
       const next = { ...prev };
@@ -132,20 +137,63 @@ export const ControlPanel: FC<ControlPanelProps> = ({
           ...
           {visibleErrors.map((err, index) => {
             ...
             return (
               <ErrorBanner
                 ...
                 code={code}
@@ -158,99 +206,127 @@ export const ControlPanel: FC<ControlPanelProps> = ({
       )}
...
@@ -268,39 +344,50 @@ export const ControlPanel: FC<ControlPanelProps> = ({
